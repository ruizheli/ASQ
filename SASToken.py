...
access_policy = AccessPolicy(permission=ContainerPermissions.READ + ContainerPermissions.LIST + ContainerPermissions.WRITE, expiry=datetime.utcnow() + timedelta(days=1))
